...
var moduleSources = ["/scripts/libs/amplitudeProcessor.js", "/scripts/libs/recorderProcessor.js", "/scripts/libs/soundFileProcessor.js"];
...
function loadAudioWorkletModules() {
  return Promise.all(moduleSources.map(function (moduleSrc) {
    return audioWorklet_ac.audioWorklet.addModule(moduleSrc);
  }));
}
